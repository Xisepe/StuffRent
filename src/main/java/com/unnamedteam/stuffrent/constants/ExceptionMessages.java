...
public class ExceptionMessages {
    ...
    public static final String passwordPatternException = "Пароль должен содержать как минимум одну цифру, латинскую букву в нижнем и врехнем регистре, специальный символ";
